...
//  AR Ruler
//
//  Created by Fatih Emre Sarman on 9.07.2024.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func calculate(){
        ...
        let formattedDistance = String(format: "%.2f", abs(distance) * 100)
        updateText(text: "\(formattedDistance) cm", atPosition: end.position)
